...
mixin _$Character {
  ...
  List<WinRate>? get rates => throw _privateConstructorUsedError;
...
abstract class $CharacterCopyWith<$Res> {
  ...
  @useResult
  $Res call({String? id, String name, String imgUrl, List<WinRate>? rates});
}
...
class _$_Character extends _Character {
  ...
  @override
  final String imgUrl;
  final List<WinRate>? _rates;
  @override
  List<WinRate>? get rates {
    final value = _rates;
  ...
  @override
  String toString() {
    return 'Character(id: $id, name: $name, imgUrl: $imgUrl, rates: $rates)';
  }
...
abstract class _Character extends Character {
  const factory _Character(
      ...
      final List<WinRate>? rates}) = _$_Character;
